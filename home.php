...
$sqlbannerad = "SELECT * FROM ad WHERE name = 'banner'";
$resultbannerad = $conn->query($sqlbannerad);
$bannerad = $resultbannerad->fetch_assoc();
                ?>

    <div class="container advertise d-flex justify-content-center align-items-center ">
        <div class="advertiseimg" style="background-image:url('upload/ads/<?php echo $bannerad['content'] ?>')"></div>
    </div>

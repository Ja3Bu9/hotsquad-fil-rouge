...
?>
                            ...
                            <input type="text" name="comment" placeholder="What are your thoughts?" required>
               ...
               $resultcomment = $conn->query($sqlcomment);
                ...
                while($comment = $resultcomment->fetch_assoc())  {
                    ...
                    <div class="row  align-items-center" style="margin-left: 2%;">
                        <div class="userpic" style="background-image: url('upload/user/<?php echo $comment['user_photo'] ?>');" ></div>
